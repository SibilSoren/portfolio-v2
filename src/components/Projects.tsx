...
const projects: Project[] = [
  {
    ...
    description: [
      "TravelPlanner.ai takes the hassle out of trip planning by offering personalized recommendations based on your destination, number of days, and total guests. With just a few inputs, the app curates must-visit places, ensuring a well-organized itinerary for an unforgettable journey. Whether you're planning a solo adventure or a group trip, TravelPlanner.ai helps you explore new destinations efficiently and effortlessly.",
    ],
    technologies: [
      "React-Vite",
      "TailwindCSS",
    ...
    githubLink: "https://github.com/SibilSoren/travelplanner.ai",
    liveLink: "https://travelplanner-ai.vercel.app/",
  },
  // {
